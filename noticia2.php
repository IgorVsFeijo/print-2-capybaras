    ...
    <div class="container text-center espaço_noticia">
        <div class="row">
            ...
            <h3>Cidade</h3>
                ...
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_agro_2.webp" alt="Imagem referente a noticia do festival encontro ecologico">
                </figure>
            ...
            <section class="col-lg-3 col-md-3 col-sm-12 not_vejamais">
                <h4>VEJA MAIS</h4>
                <figure>
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_cancer_2.webp" alt="Imagem referente a noticia sobre a prevenção do cancer de prostata">
                </figure>
                ...
                <figure>
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_jose_2.webp" alt="Imagem referente a noticia do festival Jose cabinda">
                </figure>
                <a class="not_link text-start" href="#">
                ...
                <figure>
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_imoveis_2.webp" alt="Imagem referente a noticia da abertura da anistia para regularização de imóveis">
                </figure>
                <a class="not_link text-start" href="#">
                ...
                <figure>
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_rotatoria_2.webp" alt="Imagem referente a noticia da construção da rotatoria fixa">
                </figure>
                <a class="not_link text-start" href="#">
                ...
                <figure>
                <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_cmdj_2.webp" alt="Imagem referente a noticia sobre a abertura das inscrições do CMDJ">
                </figure>
                <a class="not_link text-start" href="#">
