    ...
    <div class="container text-start">
        ...
        <div class="row text-start">
            ...
            <div class="row">
                ...
                <section class="col-lg-7 col-md-7 col-sm-12 not_i_shadow">
                    ...
                    <figure>
                    <a href="../print-2-capybaras/noticia2.php"><img src="../print-2-capybaras/imgs/turismo/imgs_not/not_agro.webp" alt="Imagem referente ao evento e noticia agroecologico"></a>
                    </figure>
                ...
                <section class="col-lg-3 col-md-3 col-sm-12 not_i_shadow">
                    ...
                    <div>
                        <figure>
                        <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_cancer.webp" alt="Imagem referente a noticia da prevenção do cancer de prostata">
                        </figure>
                    ...
                    <div>
                        <figure>
                        <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_jose.webp" alt="Imagem referente a noticia do festival José Cabinda">
                        </figure>
                    ...
                    <div>
                        <figure>
                        <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_imoveis.webp" alt="Imagem referente a noticia sobre abertura da anistia para regularização de imóveis">
                        </figure>
        ...
        <aside class="not_back text-center">
            <div class="row">
                ...
                <section class="col-lg-5 col-md-5 col-sm-5 not_i_shadow">
                    <h3 class="hide">h3 - Section</h3>
                    <figure>
                    <img class="img-fluid img-thumbnail rounded" src="../print-2-capybaras/imgs/turismo/imgs_not/not_qualifica.webp" alt="Imagem referente a noticia da abertura de inscrições da qualifica são roque">
                    </figure>
                ...
                <section class="col-lg-5 col-md-5 col-sm-5 not_i_shadow">
                    <h3 class="hide">h3 - Section</h3>
                    <figure>
                    <img class="img-fluid img-thumbnail rounded" src="../print-2-capybaras/imgs/turismo/imgs_not/not_fanfarra.webp" alt="Imagem referente a noticia do festival municipal de sao roque uma triunfante da fanfarra venceu">
                    </figure>
            ...
            <section class="col-lg-5 col-md-5 col-sm-5 not_i_shadow">
                    <h3 class="hide">h3 - Section</h3>
                    <figure>
                    <img class="img-fluid img-thumbnail rounded" src="../print-2-capybaras/imgs/turismo/imgs_not/not_zeladoria.webp" alt="Imagem referente a noticia das ações da zeladoria">
                    </figure>
                ...
                <section class="col-lg-5 col-md-5 col-sm-5 not_i_shadow">
                    <h3 class="hide">h3 - Section</h3>
                    <figure>
                    <img class="img-fluid img-thumbnail rounded" src="../print-2-capybaras/imgs/turismo/imgs_not/not_cmdj.webp" alt="Imagem referente a noticia da abertura das inscrições para eleição do CMDJ">
                    </figure>
        ...
        <aside>
            ...
            <section class="col-lg-5 col-md-5 col-sm-5 not_i_shadow">
                    ...
                    <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_rotatoria.webp" alt="Imagem referente a noticia da rotatoria fixa sendo construida">
                    </figure>
                ...
                <section class="col-lg-5 col-md-5 col-sm-5 text-start not_i_shadow">
                    <h3 class="hide">h3 - Section</h3>
                    <figure class="text-center">
                    <img src="../print-2-capybaras/imgs/turismo/imgs_not/not_circo.webp" alt="Imagem referente a noticia do festival da magia do circo em são roque">
                    </figure>
