...
<body>
    ...
    <div class="container">
        <main class="row cidadao">
            ...
            <article class="row sombra cidadao_servicos cidadao_assistencia">
                    <h2 class="text-center">Assistência social</h2>
        ...
        <div class="col-12">
            <div class=" row justify-content-between">
                <article class="col-lg-6 col-md-12 col-sm-12 sombra cidadao_servicos">
                ...
                <article class="col-lg-5 col-md-12 col-sm-12 sombra cidadao_servicos">
