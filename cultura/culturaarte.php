                    ...
                    <div class="row col-12">
                      <section class="col-md-6 monumento_cultural">
                        <h3>Roteiro do Vinho</h3>
                          <figure>
                              <img src="../imgs/cultura/roteirovinho1.jpg" alt="uma foto frontal da Vinícola Goes, a principal vinícola de São Roque e uma das primeiras">
                          </figure>
                      ...
                      <section class= "col-md-6">
                        <h3>Brasital</h3>
                        <figure>
                            <img src="../imgs/cultura/brasital.jpg" alt="foto tirada da entrada da Brasital, com os prédios e a torre capturados e um céu aberto.">
                        </figure>
                        ...
                        <!-- MODELO PICTURE
                        <picture>
                          <source srcset="../imgs/cultura/saoroque.jpg" media="(min-width: 992px)"/>
                          <img src="../imgs/cultura/brasital.jpg" alt="">
                        </picture>
                        -->
                    ...
                    <div class="row col-12">
                      <section class= "col-md-6">
                        ...
                        <figure>
                            <img src="../imgs/cultura/quilombocarmo2.jpg" alt="parte da comunidade do Quilombo do Carmo, com algumas casas e uma árvore">
                        </figure>
                      ...
                      <section class= "col-md-6">
                          ...
                          <figure>
                              <img src="../imgs/cultura/capelasantoantônio.jpg" alt="Entrada da Capela de Santo Antônio, localizada no Sítio Santo Antônio, uma relíquia do passado da cidade na época bandeirante">
                          </figure>
                    ...
                    <section class= "col-md-6">
                          ...
                          <figure>
                              <img src="../imgs/cultura/morrosaboó.jpg" alt="visão de longe do Morro do Saboó, um dos principais símbolos naturais da cidade e o ponto mais alto desta também">
                          </figure>
                      ...
                      <section class= "col-md-6">
                          ...
                          <figure>
                              <img src="../imgs/cultura/morrocruzeiro.jpg" alt="foto tirada abaixo do monumento no Morro, capturando a cruz e parte da estátua de São Roque enquanto ocorre uma procissão próxima">
                          </figure>
